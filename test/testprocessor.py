...
class TestProcessor(unittest.TestCase):
    ...
    def testGetCryptoPriceHistoricalPriceValueFromBadCryptoToFiat(self):    
        ...
        self.assertEqual(resultData.getWarningMessage(resultData.WARNING_TYPE_COMMAND_VALUE), "WARNING - price value symbol ETH differs from both crypto (BTC) and fiat (USD) of last request. -v parameter ignored !")
    ...
    def testGetCryptoPriceHistoricalPriceValueFromBadFiatToCrypto(self):    
        ...
        self.assertEqual(resultData.getValue(resultData.RESULT_KEY_PRICE_VALUE_CRYPTO), None)
        self.assertEqual(resultData.getValue(resultData.RESULT_KEY_PRICE_VALUE_FIAT), None)
        self.assertEqual(resultData.getWarningMessage(resultData.WARNING_TYPE_COMMAND_VALUE), "WARNING - price value symbol EUR differs from both crypto (BTC) and fiat (USD) of last request. -v parameter ignored !")
