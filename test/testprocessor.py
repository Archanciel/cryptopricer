...
class TestProcessor(unittest.TestCase):
    ...
    def testGetCryptoPriceHistoricalPriceValueFromBadCryptoToUnit(self):    
        ...
        self.assertEqual(resultData.getWarningMessage(resultData.WARNING_TYPE_COMMAND_VALUE), "WARNING - price value symbol ETH differs from both crypto (BTC) and unit (USD) of last request. -v parameter ignored and removed")
    ...
    def testGetCryptoPriceHistoricalPriceValueFromBadUnitToCrypto(self):    
        ...
        self.assertEqual(resultData.getValue(resultData.RESULT_KEY_PRICE_VALUE_CRYPTO), None)
        self.assertEqual(resultData.getValue(resultData.RESULT_KEY_PRICE_VALUE_UNIT), None)
        self.assertEqual(resultData.getWarningMessage(resultData.WARNING_TYPE_COMMAND_VALUE), "WARNING - price value symbol EUR differs from both crypto (BTC) and unit (USD) of last request. -v parameter ignored and removed")
