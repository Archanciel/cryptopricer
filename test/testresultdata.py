...
class TestResultData(unittest.TestCase):
    ...
    def testInit(self):
        ...
        self.assertEqual(self.resultData.getValue(self.resultData.RESULT_KEY_OPTION_TIME_STAMP), None)
        self.assertEqual(self.resultData.getValue(self.resultData.RESULT_KEY_OPTION_DATE_TIME_STRING), None)
