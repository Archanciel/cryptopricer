...
# value and fiat options scenarios
...
# value, fiat and price options scenarios
	
	def testScenarioHistoDayFullThenPartialRequestsOptionPriceNoSave(self):
		'''
		This test verifies that the partial request price option no save remains active until
		new full request or option cancelling.
		'''
		# first entry: full request
		inputStr = 'chsb btc 20/12/20 hitbtc'
		...
		# next entry: partial request option price no save
		inputStr = '-p0.0000105'
		printResult, fullCommandStrNoOptions, fullCommandStrWithNoSaveOptions, fullCommandStrWithSaveOptionsForHistoryList, fullCommandStrForStatusBar = self.controller.getPrintableResultForInput(
			inputStr)
		self.assertEqual(
			'CHSB/BTC on HitBTC: 20/12/20 00:00P 0.0000105', printResult)
		self.assertEqual('chsb btc 20/12/20 00:00 hitbtc', fullCommandStrNoOptions)
		self.assertEqual('chsb btc 20/12/20 00:00 hitbtc -p0.0000105', fullCommandStrWithNoSaveOptions)
		self.assertEqual(None, fullCommandStrWithSaveOptionsForHistoryList)
		self.assertEqual(
			'chsb btc 20/12/20 00:00 hitbtc -p0.0000105',
			fullCommandStrForStatusBar)
		...
		printResult, fullCommandStrNoOptions, fullCommandStrWithNoSaveOptions, fullCommandStrWithSaveOptionsForHistoryList, fullCommandStrForStatusBar = self.controller.getPrintableResultForInput(
			inputStr)
		self.assertEqual(
			'CHSB/ETH on HitBTC: 20/12/20 00:00P 0.0000105', printResult)
		self.assertEqual('chsb eth 20/12/20 00:00 hitbtc', fullCommandStrNoOptions)
		self.assertEqual('chsb eth 20/12/20 00:00 hitbtc -p0.0000105', fullCommandStrWithNoSaveOptions)
		self.assertEqual(None, fullCommandStrWithSaveOptionsForHistoryList)
		self.assertEqual(
			'chsb eth 20/12/20 00:00 hitbtc -p0.0000105',
			fullCommandStrForStatusBar)
		
		# next entry: full request to cancel -p option
		inputStr = 'chsb btc 20/12/20 hitbtc'
		printResult, fullCommandStrNoOptions, fullCommandStrWithNoSaveOptions, fullCommandStrWithSaveOptionsForHistoryList, fullCommandStrForStatusBar = self.controller.getPrintableResultForInput(
			inputStr)
		self.assertEqual(
		...
		# next entry: again partial request option price no save
		inputStr = '-p0.0000105'
		printResult, fullCommandStrNoOptions, fullCommandStrWithNoSaveOptions, fullCommandStrWithSaveOptionsForHistoryList, fullCommandStrForStatusBar = self.controller.getPrintableResultForInput(
			inputStr)
		self.assertEqual(
		...
		# next entry: partial request to remove option price no save
		inputStr = '-p0'
		printResult, fullCommandStrNoOptions, fullCommandStrWithNoSaveOptions, fullCommandStrWithSaveOptionsForHistoryList, fullCommandStrForStatusBar = self.controller.getPrintableResultForInput(
			inputStr)
		self.assertEqual(
	...
	def testScenarioHistoDayFullThenPartialRequestsOptionValueOptionFiatSave(self):
		...
		printResult, fullCommandStrNoOptions, fullCommandStrWithNoSaveOptions, fullCommandStrWithSaveOptionsForHistoryList, fullCommandStrForStatusBar = self.controller.getPrintableResultForInput(
			inputStr)
		self.assertEqual(
			'4013.96495336 CHSB/0.04258817 BTC/1000 USD.Kraken on HitBTC: 20/12/20 00:00C 0.00001061 0.24913023',
			printResult)
		self.assertEqual('chsb btc 20/12/20 00:00 hitbtc', fullCommandStrNoOptions)
		self.assertEqual('chsb btc 20/12/20 00:00 hitbtc -v1000usd', fullCommandStrWithNoSaveOptions)
		self.assertEqual('chsb btc 20/12/20 00:00 hitbtc -fsusd.kraken', fullCommandStrWithSaveOptionsForHistoryList)
...
#	unittest.main()
	...
	tst.setUp()
	tst.testScenarioHistoDayFullThenPartialRequestsOptionPriceNoSave()